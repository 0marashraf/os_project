...
uint32*ptr_page_table = NULL;
	...
	{
		ptr_page_table[PDX(virtual_address)] = ptr_page_table[PDX(virtual_address)] & 0 ;
		ptr_page_table[PTX(virtual_address)] = ptr_page_table[PTX(virtual_address)] & 0 ;
		*ptr_page_table = *ptr_page_table & 0;
	}
	else
	{
		panic("Invaled va");
